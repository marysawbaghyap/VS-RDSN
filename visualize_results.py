...
#     axs[0].plot(range(n), gtscore, color='red')
#     axs[0].set_xlim(0, n)
#     axs[0].set_ylabel('Ground Truth Score')
#     axs[0].set_xticks([])
#     axs[1].set_title("video {} F-score {:.1%}".format(key, fm))
#     axs[1].plot(range(n), score, color='blue')
#     axs[1].set_xlim(0, n)
#     axs[1].set_xlabel('Frame')
#     axs[1].set_ylabel('Machine Summary Score')
#     axs[1].set_xticks(range(0, n, int(n/10)))  # Adjust this as needed
#     fig.tight_layout()
#     fig.savefig(osp.join(osp.dirname(args.path), 'score_' + key + '.png'))
#     plt.close()
